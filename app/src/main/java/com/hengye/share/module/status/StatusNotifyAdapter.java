...
public class StatusNotifyAdapter extends CommonAdapter<Status>
...
//    private Callback mCallback;
    ...
    public StatusNotifyAdapter(Context context, List<Status> data, RecyclerView recyclerView) {
        super(context, data);
...
//        }
    ...
    public StatusDefaultViewHolder onCreateBasicItemViewHolder(ViewGroup parent, int viewType) {
        return new StatusDefaultViewHolder(LayoutInflater.from(getContext()).inflate(R.layout.item_status_notify_total, parent, false));
    }
...
//        }
    ...
    public void startPersonHomePage(int position) {
        ...
        if (status == null || vh == null) {
            return;
        }
        PersonalHomepageActivity.start(getContext(), vh.mStatusTitle.mAvatar, status.getUserInfo());
    }

    public void startStatusDetail(boolean isRetweet, int position) {
