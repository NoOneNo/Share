...
public class StatusActonPresenter extends RxPresenter<StatusActionContract.View>
    ...
    @Override
    public void likeStatus(final Status topic) {
    ...
    @Override
    public void collectStatus(final Status topic) {
        ...
        Single<WBStatus> single = favorited ?
        ...
        single
                ...
                .subscribe(new BaseSingleObserver<WBStatus>() {
                    @Override
                    public void onSuccess(StatusActionContract.View view, WBStatus wbStatus) {
    ...
    private Function<WBAttitude, Single<WBResult>> flatWBAttitude() {
        if (mFlatWBAttitude == null) {
            mFlatWBAttitude = new Function<WBAttitude, Single<WBResult>>() {
                @Override
                public Single<WBResult> apply(WBAttitude wbStatusComments) throws Exception {
                    WBResult wbResult = new WBResult();
                    if (wbStatusComments != null) {
