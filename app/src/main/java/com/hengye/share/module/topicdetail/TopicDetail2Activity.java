...
public class TopicDetail2Activity extends BaseActivity implements TopicDetailMvpView, View.OnClickListener, DialogInterface.OnClickListener {
...
//        mFab.setOnClickListener(this);
        ...
        mListView.setAdapter(mAdapter = new TopicComment2Adapter(this, new ArrayList<TopicComment>()));
...
//                        public void run() {
                    ...
                    if (convertView != null && convertView.getTag() != null) {
                        TopicComment2Adapter.TopicCommentViewHolder tcv = (TopicComment2Adapter.TopicCommentViewHolder) convertView.getTag();
                        if (tcv != null) {
                            startView = tcv.mTopicTitle.mAvatar;
                        }
                    }
                    if (startView == null) {
                        PersonalHomepageActivity.start(TopicDetail2Activity.this, tc.getUserInfo());
                    } else {
                        PersonalHomepageActivity.start(TopicDetail2Activity.this, startView, tc.getUserInfo());
                    }
                ...
                if (status == TopicPublishService.STATUS_SUCCESS) {
                    ...
                    sb.setAction(R.string.label_topic_publish_retry, new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            TopicPublishService.publish(TopicDetail2Activity.this, topicDraft);
                        }
                    });
                    sb.show();
                }
        ...
        if (isSelectedCommentTab()) {
            ...
            switch (which) {
                ...
                case DialogBuilder.REPOST_DETAIL:
                    startActivity(TopicDetail2Activity.getStartIntent(this, topicComment.toTopic(), true));
                    break;
