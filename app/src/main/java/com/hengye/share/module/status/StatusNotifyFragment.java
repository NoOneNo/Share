...
public class StatusNotifyFragment extends ShareLoadDataCallbackFragment<Status> implements StatusContract.View{
    ...
    public static StatusNotifyFragment newInstance(StatusPresenter.StatusGroup statusGroup, String uid, String name, boolean isRestore) {
        StatusNotifyFragment fragment = new StatusNotifyFragment();
        fragment.setArguments(getBundle(statusGroup, isRestore, uid, name));
        return fragment;
    }

    public static StatusNotifyFragment newInstance(StatusPresenter.StatusGroup statusGroup) {
        return newInstance(statusGroup, false);
    }

    public static StatusNotifyFragment newInstance(StatusPresenter.StatusGroup statusGroup, boolean isRestore) {
