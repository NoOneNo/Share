package com.hengye.share.support;
...
import com.hengye.share.support.ActionBarDrawerToggleHoneycomb;
 ...
 * ActionBar theme.
 */
public class ActionBarDrawerToggleCustom implements DrawerLayout.DrawerListener {

    /**
     * Allows an implementing Activity to return an {@link ActionBarDrawerToggleCustom.Delegate} to use
    ...
    private int mGravityCompat = GravityCompat.START;

    public int getGravityCompat() {
        return mGravityCompat;
    }
     ...
     *                                  for accessibility
     */
    public ActionBarDrawerToggleCustom(Activity activity, DrawerLayout drawerLayout,
     ...
     * <p>
     * Please use {@link #ActionBarDrawerToggleCustom(Activity, DrawerLayout, int, int)} if you are
     ...
     * animation.
     */
    <T extends Drawable & DrawerToggle> ActionBarDrawerToggleCustom(Activity activity, Toolbar toolbar,
    ...
    public void syncState() {
        if (mDrawerLayout.isDrawerOpen(mGravityCompat)) {
        ...
        if (mDrawerIndicatorEnabled) {
            setActionBarUpIndicator((Drawable) mSlider,
                    mDrawerLayout.isDrawerOpen(mGravityCompat) ?
    ...
    private void toggle() {
        if (mDrawerLayout.isDrawerVisible(mGravityCompat)) {
            mDrawerLayout.closeDrawer(mGravityCompat);
        } else {
            mDrawerLayout.openDrawer(mGravityCompat);
        }
    }
