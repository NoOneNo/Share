...
/**
 * Entity mapped to table "STATUS_DRAFT".
 */
@Entity(active = true)
public class StatusDraft implements java.io.Serializable {
    ...
    @Generated
    private transient StatusDraftDao myDao;
    ...
    public StatusDraft(Long id) {
        this.id = id;
    }

    @Generated
    public StatusDraft(Long id, String content, java.util.Date date, String urls, String uid, String targetStatusJson, String targetStatusId, String targetCommentId, String targetCommentUserName, String targetCommentContent, String assignGroupIdStr, String address, Long publishTiming, Integer isCommentOrigin, int status, Integer isMention, Integer type, Integer parentType) {
        this.id = id;
        this.content = content;
        this.date = date;
        this.urls = urls;
        this.uid = uid;
        this.targetStatusJson = targetStatusJson;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getStatusDraftDao() : null;
    }
    ...
    public String getTargetStatusJson() {
        return targetStatusJson;
    }

    public void setTargetStatusJson(String targetStatusJson) {
        this.targetStatusJson = targetStatusJson;
    }
    ...
    */
    ...
    public boolean equals(Object o) {
        ...
        StatusDraft that = (StatusDraft) o;
    ...
    transient Status originalStatus, targetStatus;

    public Status getOriginalStatus() {
        if (originalStatus == null) {
            originalStatus = generateStatus();
        }
        return originalStatus;
    }

    public Status getTargetStatus() {
        if (getTargetStatusJson() != null && targetStatus == null) {
            targetStatus = GsonUtil.fromJson(getTargetStatusJson(), Status.class);
        }
        return targetStatus;
    }
            ...
            case StatusDraftHelper.REPLY_COMMENT:
                if (CommonUtil.noEmpty(getTargetCommentUserName(), getTargetCommentContent())) {
                    return "回复" + "@" + getTargetCommentUserName() + ":" + getContent()
                            ...
                            + "//" + "@" + getTargetStatus().getUserInfo().getName() + ":" + getTargetStatus().getContent();
                }
                break;
            default:
                break;
    ...
    public Status generateStatus() {
        return StatusDraftHelper.getStatus(this);
    }
    ...
    private String getAssignGroupName() {
        return StatusPresenter.StatusGroup.getStatusGroupName(assignGroupIdStr);
    }
