...
public class TestTopicFragment extends RecyclerRefreshFragment<Topic> implements TopicMvpView {

    public static TestTopicFragment newInstance(TopicPresenter.TopicGroup topicGroup, String uid, String name) {
        TestTopicFragment fragment = new TestTopicFragment();
    ...
    public static TestTopicFragment newInstance(TopicPresenter.TopicGroup topicGroup) {
        return newInstance(topicGroup, null, null);
    }

    public static TestTopicFragment newInstance(TopicPresenter.TopicType topicType, String uid, String name) {
...
//    }
    ...
    protected void handleBundleExtra() {
        topicGroup = new TopicPresenter.TopicGroup(TopicPresenter.TopicType.ALL);
...
//        name = getArguments().getString("name");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new TopicAdapter(getContext(), new ArrayList<Topic>(), getRecyclerView());
        getRecyclerView().setAdapter(mAdapter);
        mTopicHandler = new TopicIdHandler(mAdapter);
    ...
    TopicIdHandler<Topic> mTopicHandler;
