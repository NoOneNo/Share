...
public class TopicContentUrlSpan2 extends CharacterStyle implements ParcelableSpan, SimpleClickableSpan {

    private final String mURL;

    public TopicContentUrlSpan2(String url) {
        mURL = url;
    }

    public TopicContentUrlSpan2(Parcel src) {
        mURL = src.readString();
    }
