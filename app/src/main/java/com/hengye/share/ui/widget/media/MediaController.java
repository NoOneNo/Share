...
//        View playBtn = makePlayButton();
//        FrameLayout.LayoutParams playBtnParams = new FrameLayout.LayoutParams(
//                ViewGroup.LayoutParams.WRAP_CONTENT,
//                ViewGroup.LayoutParams.WRAP_CONTENT
//        );
//        playBtnParams.gravity = Gravity.CENTER;
//        addView(playBtn, playBtnParams);
...
//                mWindowManager.removeView(mDecor);
    ...
    OnTouchListener mTouchHelperListener = new OnTouchListener() {
        @Override
        public boolean onTouch(View v, MotionEvent event) {
...
//        show(sDefaultTimeout);
    ...
    private final View.OnClickListener mFullscreenListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            mPlayer.fullscreen(mIsFullScreen = !mIsFullScreen);
        }
    };
