...
public class StatusEditText extends AppCompatEditText {
    ...
    public StatusEditText(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        }
    ...
    private class HackInputConnection extends InputConnectionWrapper {
        ...
        public HackInputConnection(InputConnection target, boolean mutable, StatusEditText editText) {
