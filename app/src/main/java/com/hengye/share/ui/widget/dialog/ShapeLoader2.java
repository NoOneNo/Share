...
public class ShapeLoader2 {
     ...
     * singleton
     */
    private static ShapeLoader2 shapeLoader;
    public static ShapeLoader2 getInstance(){
        if(shapeLoader == null){
            shapeLoader = new ShapeLoader2();
        }
        return shapeLoader;
    }
