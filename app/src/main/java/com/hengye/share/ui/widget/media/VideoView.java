 ...
 * play position, Applications should
...
//                            WindowManager$BadTokenException: Unable to add window -- token null is not for an application
    ...
    private OnCloseListener mCloseListener = new OnCloseListener() {
        @Override
        public void onClose(MediaPlayer mp) {
            release(true);
            if(mOnCloseListener != null){
                mOnCloseListener.onClose(mp);
            }
        }
    };
    ...
    public void setOnFullscreenListener(OnFullscreenListener fullscreenListener) {
        this.mOnFullscreenListener = fullscreenListener;
    }
...
//        }
    ...
    @Override
    public void close() {
        mCloseListener.onClose(mMediaPlayer);
    }
