...
public class ChromeLoadingView extends View {
    ...
    public ChromeLoadingView(Context context) {
        this(context, null);
    }

    public ChromeLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ChromeLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
