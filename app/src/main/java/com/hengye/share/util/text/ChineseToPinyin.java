package com.hengye.share.util.text;
...
//
//        System.out.print("中文首字母转换前 : "  + str + '\n');
//
//        System.out.println("中文首字母后 ："+getPYIndexStr(str,true));
//
//    }
    ...
    public static String getPinyin(String name){
        try {
            if (!TextUtils.isEmpty(name) && name.length() >= 1) {
                ...
                return ChineseToPinyin.getPYIndexStr(s, true);
            }
        }catch (Exception e){
            e.printStackTrace();
        }
    ...
    public static String getPYIndexStr(String strChinese, boolean bUpCase){
        ...
        try{
            if(bUpCase) {
                strChinese = strChinese.toUpperCase();
            }else{
