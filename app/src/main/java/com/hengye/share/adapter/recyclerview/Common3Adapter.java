...
//
//public abstract class Common3Adapter<T> extends Header3Adapter<ItemViewHolder> implements DataAdapter<T>, ItemTouchHelperAdapter {
//
...
//
//    public Common3Adapter() {
//    }
//
//    public Common3Adapter(Context context) {
//        this(context, new ArrayList<T>());
//    }
//
//    public Common3Adapter(Context context, List<T> data) {
//        init(context, data);
//    }
//
