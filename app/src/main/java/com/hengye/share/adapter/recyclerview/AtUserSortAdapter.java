...
public class AtUserSortAdapter extends GroupAdapter<AtUserSortAdapter.Letter, AtUser> {
    ...
    public static class GroupHolder extends CommonAdapter.ItemViewHolder<Letter> {
    ...
    public static class ChildHolder extends CommonAdapter.ItemViewHolder<AtUser> {
