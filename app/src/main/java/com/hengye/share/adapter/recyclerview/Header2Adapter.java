...
//        showLoadingView(view, -1);
//    }
//
//    public void showLoadingView(View view, int index) {
//        if (index < 0) {
...
//        return isContainView(view, mHeaderContainer);
//    }
//
//    public boolean isContainFooter(View view){
//        return isContainView(view, mFooterContainer);
//    }
//
//    private boolean isContainView(View view, ViewGroup where){
//        if(where != null){
//            int len = where.getChildCount();
//            for(int i = 0; i < len; i++){
//                View child = where.getChildAt(i);
//                if(child == view){
//                    return true;
//                }
//            }
